---
{"dg-publish":true,"permalink":"/general-files/lore-and-worldbuilding/"}
---
...
**Type:** Planet ruled by all-powerful god (formerly "Mr Delero") **Known Geography:** [[Locations/Eros\|Eros]] continent (only known continent)
...
- Dwarves and Goliaths were the original races created to rule together
- Coexisted peacefully with advanced civilizations

**The Bane's Corruption:**

- [[NPCs/The Bane\|The Bane]] is evil itself incarnate (not dragon/demon/god)
- Has many names across races and time
- Corrupted entire dwarven race
- Corrupted dwarves turned against goliaths

**The Great War:**

- Dwarves vs Goliaths fought to near-extinction
- Only handful of survivors from each race
- Explains the extreme rarity of both races today

**Dragon Gods' Intervention:**

- Multiple dragon gods ruled as THE gods
- Bonded together to fight [[NPCs/The Bane\|The Bane]]
- One dragon god killed in final battle
- Successfully imprisoned [[NPCs/The Bane\|The Bane]]
- Dead god's blood used in Bane Watcher ritual

**Legacy:**

- Explains extreme rarity of dwarves and goliaths
- Underground dwarven highway network remains
- [[Organisations/Bane Watchers\|Bane Watchers]] founded after war
- Ancestral trauma in both races

---

### The True History of Eros (Artefact)

**Description:** Old dwarfish scroll in unknown dialect. Colour faded, ornate text. Described as an old religious or sacred text. Found in the dungeon beneath the bandit castle near [[Locations/Sylobelle\|Sylobelle]] (Sessions 6–8).

**Known Content:**

- The word **"Vilthaltron"** can be made out - meaning unknown
- References the **Battle of Anuthrata** - a conflict between goliaths and dwarves (details unknown)
- Mentions dragons being worshipped by goliaths and dwarves in ages past

**Status:** Artefact found by party; full contents untranslated. Significance of "Vilthaltron" and the Battle of Anuthrata unknown.

**Open Questions:**

- What is Vilthaltron? (Name, place, entity, or concept?)
- What was the Battle of Anuthrata, and how does it connect to the First Age war between dwarves and elves?
- Are goliaths more central to ancient history than currently understood?
...
**Current Status:** Dangerous - [[NPCs/The Bane\|The Bane]] presence detected, collapsed sections, unknown creatures
...
- **Can flow physically through a Bane Watcher's body to activate external Bane-connected structures** (Session 37 - flowed from [[Party Members/Ser Tessell Highfrost\|Ser Tessell Highfrost]]'s palm into garrison wall, activating hidden cult symbol; retracted upon passage sealing; only Tessell could sense or trigger it)
...
**New Manifestations (Sessions 24-38):**
...
- **Dragon's Breath manifesting as green Bane flame** (Session 36 - Elvva's innate draconic ability corrupted)
- **Physical outflow through Bane Watcher's palm** (Session 37 - see Capabilities above)
...
**Abjuration:** Protection, barriers, banishment **Conjuration:** Summoning, teleportation, creation **Divination:** Information, foresight, revelation **Enchantment:** Mind control, manipulation of will **Evocation:** Energy manipulation, power, destruction (Led by [[NPCs/Patriarch Siegfried Wildner\|Patriarch Siegfried Wildner]]) **Illusion:** Deception, perception manipulation **Necromancy:** Life/death manipulation (creating undead is evil, resurrection accepted) **Transmutation:** Change and adaptation

**The Mages' Tower ([[Locations/Belendar\|Belendar]]):** Each floor = different school (distinct color), multicolored skyscraper
...
**Warg Ability ([[Party Members/Lady Odonia of Galantri\|Lady Odonia of Galantri]]):**
...
- Worshipped by [[Party Members/Ser Tessell Highfrost\|Ser Tessell Highfrost]]
- Philosophy: Self-sacrifice for others' benefit

#### Mr Delero:

- All-powerful god ruling [[Locations/Lorellia\|Lorellia]] (meta-level deity)

#### Unknown Deities:

- Various gods across [[Locations/Eros\|Eros]], celestial beings granting power

### Religious Institutions

#### Cathedral of Gentle Redemption ([[Locations/Thalas'Miriel\|Thalas'Miriel]]):

- Currently siding with rebels (deity/philosophy unknown)
...
**Bareknuckle Boxing:** Popular at [[Locations/Crossroads Inn\|Crossroads Inn]], tokens of pride **Chariot Racing:** International sport, high-stakes competition **Bardic Performance:** Music, dance, verse central to culture
...
**Common:** Trade language (Common script) **Elvish:** Language of [[Locations/Odessia\|Odessia]] (Elvish script - also Sylvan, Undercommon) **Dwarvish:** Ancient First Age language (Dwarvish script - also Giant, Gnomish, Goblin, Orc, Primordial) **Draconic:** Dragons and dragonborn (Draconic script)

### Exotic Languages

**Planar:** Abyssal (demons), Celestial, Infernal (devils), Primordial (elementals), Deep Speech (telepathic)

**Found in Campaign:** Orcish word "EARTH" at [[Locations/Sylobelle\|Sylobelle]] wolf shrine
...
**Northern ([[Locations/Nolunia\|Nolunia]]):** Colder, humans/centaurs, independent city-states **Central ([[Locations/Odessia\|Odessia]]):** Temperate forests, rivers, agricultural, mountains (northwest), balanced climate **Southern ([[Locations/Immortal Draconic Empire\|Immortal Draconic Empire]]):** Unknown climate, hostile territory

### Natural Features

**Central Lake:** Large lake with [[Organisations/Bane Watchers\|Bane Watchers]] citadel island **Forests:** Deep forests around [[Locations/Belendar\|Belendar]], elven towns, sacred groves **Rivers:** River Silverdue through [[Locations/Belendar\|Belendar]], multiple rivers, trade routes **Mountains:** Northwest [[Locations/Odessia\|Odessia]], stone mining ([[Locations/Ulvenora\|Ulvenora]]), foothills **Badlands:** East of [[Locations/Odessia\|Odessia]], dangerous, unexplored
...
**High King Everglade** (Deceased - Session 23) ├── **First Son: Gaelin** (Deceased, no legitimate heirs) │ └── with [[NPCs/Elincia Flowers\|Elincia Flowers]] (affair) │ ├── [[NPCs/Ser Alvar Flowers\|Ser Alvar Flowers]] (Bastard, Falcon leader) │ └── Yavanna Lightwhisper (Bastard, Falcon conspirator) │ ├── **Second Son** (Deceased "at sea") │ └── with Verona (Deceased "at sea") │ └── **[[NPCs/Avicia\|Avicia]]** - RIGHTFUL HEIR │ └── Hidden as doll for protection │ └── **[Third line - Crown Princess's parent]** └── **[[NPCs/Crown Princess Eilrora Everglade\|Crown Princess Eilrora Everglade]]** └── Currently ruling, age 24, GRANDDAUGHTER

### Succession Order

1. First son's line: Extinct (bastards excluded)
2. **Second son's line: [[NPCs/Avicia\|Avicia]]** (legitimate, rightful heir)
3. Third line: Crown Princess (legitimate but junior claim)
...
- [[Locations/Canathalas\|Canathalas]] (western port), [[Locations/Crossroads Inn\|Crossroads Inn]] (5-road junction), [[Locations/Belendar\|Belendar]] (river trade)

### Resources

- Stone ([[Locations/Ulvenora\|Ulvenora]]), agricultural products ([[Locations/Sylobelle\|Sylobelle]]), potatoes ([[Locations/Crossroads Inn\|Crossroads Inn]]), magical components ([[Locations/Belendar\|Belendar]])

### Nobility System

- Monarchy → Dukes/Duchesses → Knights → Advisors
- Mixed race society in [[Locations/Odessia\|Odessia]] (equality under law)
- Human-dominated supremacy in [[Locations/Immortal Draconic Empire\|Immortal Draconic Empire]]
- Free confederation in [[Locations/Nolunia\|Nolunia]]
