---
{"dg-publish":true,"permalink":"/general-files/campaign-reference/"}
---
...
**Last Updated:** Session 38 **Campaign:** Riders of the Storm **System:** D&D 5E  
...
- **Zorn:** Named S36 by orc wolf rider; imminent threat declared

**Next Steps:** Resolve Purple Dragonborn encounter; confirm Clara's status; exit underground complex; counter Neverwinter delegation
...
- Base: Stormhold Keep (official deed, 732 troops + Seraphine healer)
- Resources: War chest access (treasury with approval)
- Avicia: With Patriarch (education decision pending)
- Authority: Promote subordinates, execute traitors, negotiate for Princess
- Co'narr: Departed for Nolunia (Session 31)
- All members Level 6 (Session 30)

---

## Key Allies

### Royal/Military (Critical)
...
- **Duke Alaric Thorne** - Duke of Neverwinter, ally, 3 sons (Edran 35, Marek 24, Calen 16 bastard), hired Iron Finch + Crimson Pike
- **Lady Isolde of the Silver Rose** - Appointed mayor of Sylobelle (Session 31)
- Ser Silvar Glinnan (Military advisor, mansion destroyed Session 22)
- Ser Oldric the Stalwart, Ser Garet of the Wildlands (Steward candidates - not selected)

### Support

- **Ser Alric Vayne** - **NEW S37**: Former second in command, Order of the Silver Lantern; Crown loyalist; freed from garrison (S37); holding three-staircase junction as rearguard (S38)
- **Calen Thorne** - **CONFIRMED S38** (was "Brother Calen"): Combat-trained monk operating under alias; bastard son of [[NPCs/Duke Alaric Thorne\|Duke Alaric Thorne]]; aided garrison infiltration; his mentor found an identical Ember Vein site beneath [[Locations/Neverwinter\|Neverwinter]]; inside underground complex with party (S38)
- **Lord Pompaduke the Third** - **NEW Session 35**: Human bard companion (enchantment bard, formerly unnamed minstrel at Crossroads Inn), powerful bardic magic including portal creation
...
- Companions: River (Rottweiler), Bob the Whipping Boy
- **Joneyentee** - **NEW Session 31** (via tea portal): Wood Elf wizard, former party member Session 1, seeking Chronos Scepter
...
### Falcon Faction (Civil War)

- **Ser Alvar Flowers** - Bastard son of Gaelin, leading southern army, whereabouts unknown
...
### PRIMARY MISSIONS (Session 38)

- **Resolve Purple Dragonborn Encounter** - **CRITICAL IMMEDIATE**: Boss encounter unresolved (S38 cliffhanger); bearing Elik'r's family crest; threat or ally unknown
- **Confirm Clara's Status** - **CRITICAL**: Last seen on ritual chamber floor after rescue; status uncertain
- **Exit Underground Complex** - **HIGH**: Left-hand staircase to [[Locations/Cathedral of Gentle Redemption\|Cathedral of Gentle Redemption]] is known route
...
- **Rally the North** - **ACTIVE**: Secure Duke Alaric Thorne (Neverwinter), unite northern nobles for Princess
...
- ✅ **Investigate Sylobelle Murders** - Earthbound Dire Wolf defeated, earth shrine discovered, Lady Isolde appointed mayor
- ✅ **Appoint Sylobelle Steward** - Lady Isolde of the Silver Rose selected
...
- Avicia's ship petrification (who pursued? Elincia involved decades ago?)
- **Steve's True Nature:** Confirmed independent entity (Session 30), why only Elik'r can see/hear him? Why Co'narr's voice?
- **Dream Temple:** What is it? How pulls people from different locations? **Why did Dragon's Tear persist when all else disappeared?**
- **Lady Odonia's Warg Ability:** Origin from corrupted ooze transformation (Session 30), exact mechanics unknown (Annie absent)
...
1. Crown Princess (Eagle faction, ruling, junior claim)
2. Falcon bastards (Elincia/Alvar/Yavanna, attacking, illegitimate)
3. Avicia (rightful heir, hidden, identity SECRET - only party + Patriarch + Princess + Eldrin know)

**"The Vessel" = Avicia** (confirmed - Elincia failed to retrieve her)
...
- **Order of the Silver Lantern** - **S36**: Knightly order, Thalas'Miriel garrison; **leaderless (S38)**; [[NPCs/Darius Kain\|Darius Kain]] deceased; Crown loyalist faction ([[NPCs/Ser Alric Vayne\|Ser Alric Vayne]]) holding rearguard
...
## Important Secrets & Relationships
...
- Odonia: Lady of Sylobelle (land ownership), Royal Advisor (left of throne)
- Party: Marshals of the North, 712 troops, war chest access
- Stormhold Keep: Official deed granted
- Base secure but castle inaccessible (too far for immediate return)
...
- Bane Watchers have "sad existence"
- Can shorten lifespan
- More attuned = worse corruption
- Can overflow and take over host
- Sprites = normal manifestation
- Citadel visit URGENT for training/cure

---

## Party Resources (Session 28)
...
- War chest (royal treasury access with approval)
- All masonry/reconstruction costs covered

**Assets:**

- Stormhold Keep (official deed)
- Odonia: Lady of Sylobelle, Royal Advisor position
- Castle deed co-ownership (all party)
- Ornate golden sashes (ceremonial)
...
- Infinite Radiant Bow (Odonia) - +1d4 radiant, infinite ammo
- Twin Blades of the Serpent (Odonia)
- **Hearts Rend (Elik'r)** - Longsword, cursed, attuned; charges via self-inflicted damage (100 HP total); activates flaming cone (4d10+2) at full charge; named by Elik'r
- Basic Jousting Armor (Elvva)
- Hide Armour (Odonia) - **NEW Session 27**, properties unknown
...
**Items Lost (Session 30):**

- ~~Glowing Orb beacon (Odonia)~~ - disappeared with transformation in dream
- ~~Dragon chamber gems~~ - all disappeared upon waking (temporary dream items)
...
- **Session 18:** Bane Watcher initiation (dragon blood ritual, shared vision, purple dragonborn called Elik'r's name, Odonia saw Barry's gnome army)
...
- **Session 30:** Dream vision completed (forgiveness riddle), Khorrak defeated, Elvva forgave Elik'r (genuine character growth), Odonia gained Warg ability (ooze transformation), Elvva acquired Dragon's Tear gem, Elik'r's curse triggered in combat (3 psychic damage), all leveled to 6
...
- Oswick Porridgepot (halfling, transformed into Moth Queen, defeated by party)
- Moth Queen (transformed Oswick, killed by Elvva's Agonising Scorcher)

**Session 31:**

- Jon Doe (Sylobelle fisherman, throat slit 3x by Earthbound Dire Wolf)
- Earthbound Dire Wolf (earth-corrupted alpha, defeated by party)

**Session 30:**

- Khorrak the Horned Dread (dream vision minotaur, defeated by party)

**Session 26:**

- Ser Alarin Silverleaf (elf knight, affiliated with Eagle Faction, died during siege)
...
- Guy (Elik'r's squire, town square ambush)
- Ser Silvar's Servants (multiple, mansion fire)

**Earlier:**

- Gaelin, Second Son, Verona (Royal family, years ago)
...
## Spelling Reference (CRITICAL - AI Transcription Errors)
...
- **Ser Silvar Glinnan** (NOT Ser Silverleaf, Sir Silvar, Silver Glinnan, Glinnon)
- **Ser Alvar Flowers** (NOT Alvar Flour, Alva Flowers, Sir Alvar, etc.)
- **Yavanna Lightwhisper** (NOT Yavana, Javana, Yvanna, Light Whisper)
- **Eldrin Oakenhart** (NOT Eldren, Aldrin, Oakheart, Oak Heart)
- **Elincia Flowers** (NOT Alison, Alasan, Allison, Alicia, Elencia, Alencia, Thalas, Lady Alysanne - ALL SAME PERSON)
...
- **Odessia** (Kingdom - NOT Odonia, Odessa)
- **Belendar** (NOT Bellendar, Belendar, Belinder)
- **Sylobelle** (NOT Silobelle, Syllabelle, Silo Bell)
- **Stormhold Keep** (NOT Storm Hold, Stormhold Castle)
...
- **Ser** (Knight title - NOT Sir, always Ser in this campaign)
- **The Bane** (NOT Bain, The Bain, Bane)

---

## Tag Reference

**For Session Summaries:** Use status tags (active/deceased/injured), condition tags (cursed/corrupted/petrified), location tags (current position), and plot tags (mysteries/secrets) to track changes.
