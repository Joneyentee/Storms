...
**CRITICAL** | Northern Territories → [[Locations/Neverwinter\|Neverwinter]] first

**Mission:** Unite northern nobles for Crown Princess (Eagle faction). Kill/destroy rebels.
...
- [[NPCs/Purple Dragonborn\|Purple Dragonborn]] animated from ancient statue bearing [[Party Members/Elik'r Stormswallow\|Elik'r Stormswallow]]'s family crest; boss encounter unresolved
...
- [[NPCs/High Luminary Aelthir Vaelorian\|High Luminary Aelthir Vaelorian]] confirmed Falcon-aligned; publicly called for mobilisation, announced delegation to [[Locations/Neverwinter\|Neverwinter]]
- [[NPCs/Lord Pompaduke the Third\|Lord Pompaduke the Third]] operating as "Brother Algrim" in cathedral - led worship, green Bane aura from lute observed; allegiance unknown
- [[Party Members/Lady Odonia of Galantri\|Lady Odonia of Galantri]]'s Primeval Awareness detected two unidentified creature types near cathedral

**Mercenary Companies at Neverwinter:**

- **Iron Finch Company** (Captain Mara Veylan): Professional, reliable, ~8+ soldiers, hired by Duke Alaric Thorne
- **Crimson Pike** (Captain Rhyla Garron "Red Viper"): Skilled fighters, NO PERMANENT ALLEGIANCES, will switch for higher pay, STRATEGIC RISK

**Strategic Concerns:**

- Crimson Pike could be bribed by Falcon faction
- Duke hiring mercenaries suggests military preparation (for which side?)
- Iron Finch reliable if Duke supports Eagle
- Both companies encountered traveling to Neverwinter (Session 32)
...
**HIGH** | Eastern territories, [[Locations/Eastern Citadel\|Eastern Citadel]]

**Situation:** Eastern Citadel fallen silent (unprecedented). Strange creatures attacking northern settlements. Dead lands tribes possibly unified or crossing mountains (extremely rare).

**Current Objectives:**

- [ ] Investigate Eastern Citadel silence
- [ ] Assess strange creature threat
- [ ] Determine if dead lands tribes unified
- [ ] Restore border security

**Strategic Options:**

- Address after rallying north
- Send scouts/subordinates
- Visit during northern campaign
- Split forces

**Connection:** Ser Pas Rata went to Eastern Citadel before death.

**Related:** [Rally the North](https://claude.ai/chat/174466a7-5996-4c2c-acd5-cce0b6b100a7#rally-the-north) | [Pas Rata Investigation](Quests - Mysteries.md#pas-rata-investigation)

---

### Visit Bane Watcher Citadel

**CRITICAL - URGENT** | Island in central lake

**ESCALATION (Session 26):** Elvva's Bane corruption ADVANCED - green sprite manifestation. Co'narr warned: "You're further along than I thought." Can overflow and take over host. Shortened lifespan risk.

**NEW (Session 30):** Elik'r's psychological curse **triggered in combat** (friendly fire on Elvva caused "It's your fault again!" with 3 psychic damage). Demonstrates curse active and dangerous. Odonia gained Warg ability from Khorrak's green ooze transformation - may need Citadel training/understanding.

**Timing Decision:** Visit before, during, or after Rally the North (party's choice).

**Current Objectives:**

- [ ] Travel to Citadel (timing flexible but urgent)
...
- [ ] **Understand Odonia's Warg ability** (origin from Khorrak's green ooze)

**Urgency Factors:**

- Sprite manifestation = advanced corruption
- **Elik'r's curse triggers when harming Elvva** (combat liability)
- Risk of overflow (taking over host)
- Lifespan concerns
- Dormant commands could activate anytime
- Dragon's Tear properties unknown (Bane-related?)
- Warg ability origin mysterious (green ooze connection)

**Strategic Trade-off:**

- Visit now: Addresses corruption/curse, delays rallying north
- Visit later: Completes Princess mission, corruption may worsen, curse remains combat threat

**Related:** [The Bane](https://claude.ai/chat/174466a7-5996-4c2c-acd5-cce0b6b100a7#the-bane) | [Rally the North](https://claude.ai/chat/174466a7-5996-4c2c-acd5-cce0b6b100a7#rally-the-north) | [Avicia's Education](https://claude.ai/chat/174466a7-5996-4c2c-acd5-cce0b6b100a7#avicias-education-decision)
...
**CRITICAL** | Kingdom-wide civil war

**Current Status:** ~50/50 kingdom split. Princess (Eagle) ruling from capital. Ser Alvar Flowers (Falcon) leading southern rebel army.

**Session 26 Developments:**

- Elincia Flowers revealed as Thalas/Lady Alysanne (triple identity)
- Elincia escaped via fire teleportation: "The war has only just begun! The kingdom will be ours"
- Palace secured, city cleared of enemy cells
- Party commissioned as Marshals of the North

**Known Conspirators (Falcon):**

- Ser Alvar Flowers (southern army leader)
- Elincia Flowers (escaped, whereabouts unknown)
- Yavanna Lightwhisper (twin sister, whereabouts unknown)
- Anfarlan (stripped of Sylobelle)
- Multiple mysterious figures (see Mysteries)

**Current Objectives:**

- [ ] Rally northern nobles (primary mission)
- [ ] Defeat/capture Ser Alvar Flowers
- [ ] Locate and defeat Elincia Flowers
- [ ] Protect Avicia (rightful heir, identity secret)
- [ ] Determine meaning of "the kingdom will be ours"

**Party Role:** Marshals of the North with 732 troops, authority to execute rebels.

**Related:** [Rally the North](https://claude.ai/chat/174466a7-5996-4c2c-acd5-cce0b6b100a7#rally-the-north) | [Elincia's Triple Identity](Quests - Mysteries.md#elincias-triple-identity) | [What is "The Kingdom"?](Quests - Mysteries.md#what-is-the-kingdom)
...
- **Elvva's Dragon's Breath manifested as green Bane flame** - corruption progressing
- **Lord Pompaduke the Third ("Brother Algrim"):** Green Bane aura visibly rose from lute during cathedral service

**Session 30 Status:**

- **Elvva:** Advanced corruption (sprite manifestation, must take Warlock 2), possesses Dragon's Tear gem (properties unknown, possible Bane connection)
...
- **Flowed from Tessell's palm into garrison wall** (Session 37 - activated hidden cult symbol; only Tessell could sense/trigger it)
...
- [ ] Learn to control Bane Sense
- [ ] Prevent overflow
- [ ] **Examine Dragon's Tear** (unknown properties, Bane connection?)
- [ ] **Understand Odonia's transformation** (green ooze = Bane? Different supernatural force?)
- [ ] Investigate Bane presence in civil war
...
**Continue with Patriarch (Belendar):**
...
- ✅ Safest location (isolated, center of kingdom)
...
- [ ] Decide education location
- [ ] Discuss with party
- [ ] Inform Patriarch of decision
- [ ] Maintain identity secret

**Related:** [Civil War](https://claude.ai/chat/174466a7-5996-4c2c-acd5-cce0b6b100a7#eagle-vs-falcon-faction-war) | [Rally the North](https://claude.ai/chat/174466a7-5996-4c2c-acd5-cce0b6b100a7#rally-the-north) | [Visit Citadel](https://claude.ai/chat/174466a7-5996-4c2c-acd5-cce0b6b100a7#visit-bane-watcher-citadel)
