---
{"dg-publish":true,"permalink":"/sessions/session-33-26-december-2025/"}
---


**Location:** [[Locations/Fizwidget's Winter Realm\|Fizwidget's Winter Realm]] (Magical Pocket Dimension)  
**Date In-Game:** Unknown (time suspended)  
**Session Type:** ⚠️ **CANON SIDE QUEST** - [[NPCs/Fizwidget Spindleflash\|Fizwidget Spindleflash]] Winter Adventure
...
- **[[NPCs/Fizwidget Spindleflash\|Fizwidget Spindleflash]]** - Gnome trickster/reality manipulator, created pocket dimension and challenges, announced "10th Annual Husky Games" and snowball tournament
- **Pip and Palla** - Two snow sprite children who welcomed party to Frostglade and invited them to annual snowfall games
- **Clausonick** - Village elder (Santa-like figure in green, white, brown and gold), mayor of Frostglade
- **Jack Frost** - The Frost Baker, created magical pastries with wild random effects lasting one hour
- **Husky Sled Dogs** - Three teams of magical huskies (white/black, pink/white, one resembling Freddy)

---

## Locations Visited

- **[[Locations/Fizwidget's Winter Realm\|Fizwidget's Winter Realm]]** (NEW) - Magical pocket dimension with multiple areas:
    - **Snowy Field** - Awakening point in eye of blizzard, pathway to frozen lake
    - **Frozen Lake** - Half-mile wide with cracking ice, blizzard pursuing from behind, creature glimpsed beneath (fin)
    - **Mountain Slope** - Steep descent with three paths: cavern (left), snow/woods (centre), rocky/misty (right)
    - **Frostglade Village** - Festive winter settlement with cheerful inhabitants, village centre arena
    - Similar to [[Locations/Fizwidget's Carnival Realm\|Fizwidget's Carnival Realm]] (Session 27) - total reality control by Fizwidget
    - Age regression applied to all participants
    - Equipment removed/replaced with fur coats
    - Abilities suppressed (flight, fire)

---

## Special Events

### Jack Frost's Magical Pastries

After arriving in Frostglade village, Jack Frost (the Frost Baker) served each party member a magical pastry with random effects lasting one hour. Each person rolled d10 for their effect:

**[[Party Members/Liora Emberveil\|Liora Emberveil]] (rolled 3)** - Yeti Fetti Cupcake (blue-frosted with fluffy sprinkles)

- +10 to all Strength checks and saving throws
- Muscles appeared on arms

**[[Party Members/Ser Tessell Highfrost\|Ser Tessell Highfrost]] (rolled 7)** - Icicle Éclair of Intense Brain-Freeze (frozen éclair crackling with frost magic)

- Disadvantage on all Intelligence-based checks
- 25% chance (roll d4, on 1) to cast wrong cantrip
- Must randomly shout "DRAGONS ARE VEGETARIANS!"
- After shouting, must grab nearest person and whisper "You're worth it"

**[[Party Members/Elvva Beltavar\|Elvva Beltavar]] (rolled 10)** - Fruitcake of Eternal Re-gifting (brick-like fruitcake in festive paper)

- Must constantly eat fruitcake (reappears in pocket after finishing)
...
- +10 Intimidation
- -10 Stealth
- -5 Dexterity and Perception

**[[Party Members/Elik'r Stormswallow\|Elik'r Stormswallow]] (rolled 8)** - Pretzel of Polar Pact (warm pretzel shaped like snowflake)

- Small polar bear appears on shoulder
- Bear offers advice and can freeze small objects
- Must compliment bear regularly or it cries if ignored
- Bear whispers sweet nothings

**[[Party Members/Lady Odonia of Galantri\|Lady Odonia of Galantri]] (rolled 4)** - Croissant of Perpetual Slippiness (very buttery, always slightly icy)

- Hands and feet magically slippery
- Disadvantage on all Acrobatics and Sleight of Hand checks
- When running/dashing, slide additional 10 feet and cannot stop
- Constantly drops anything picked up (doors, weapons, allies, items)
- Moving downhill very fast (bonus)

---

## Quest Updates

- **Investigate [[Locations/Moth Queen Cavern\|Moth Queen Cavern]]** - Status: Suspended (interrupted by Fizwidget teleportation)
- **Rally the North** - Status: On hold
- **Visit [[Locations/Bane Watcher Citadel\|Bane Watcher Citadel]]** - Status: On hold
- **Fizwidget Investigation** - Pattern continues (second documented pocket dimension event)

---

## Combat Encounters

### Husky Sled Race (Competitive Challenge)

**Format:** Three-team race down mountain to Frostglade village  
**Prize:** Winner receives prize, loser "might die" (Fizwidget's threat)
...
- Each round: choose Control (Animal Handling), Speed (Athletics), or Tricks (Acrobatics)
- Both team members roll same skill
- Obstacles required Dexterity saves from drivers
...
- [[Party Members/Elik'r Stormswallow\|Elik'r Stormswallow]]'s firebolt set [[Party Members/Lady Odonia of Galantri\|Lady Odonia of Galantri]]'s sled on fire
- Final stretch: [[Party Members/Liora Emberveil\|Liora Emberveil]] threw snowball into [[Party Members/Elik'r Stormswallow\|Elik'r Stormswallow]]'s face whilst putting out fire
- [[Party Members/Lady Odonia of Galantri\|Lady Odonia of Galantri]] & [[Party Members/Liora Emberveil\|Liora Emberveil]] crossed finish line on fire, followed closely by others

---

### Snowball Fight Tournament (3v3)
...
- Three lives per person (snowball hits only)
- Village centre arena with six large ice pillars and smaller obstacles
- Each turn: make snowball (action), throw with Sleight of Hand (quick) or Strength (compact/powerful)

**Pastry Effects Active:**
...
- Sleight of Hand checks for quick throws
...
**None during session** (recording ended before departure)

**Expected upon departure** (Session 27 precedent):

- Return to adult ages
- Equipment restoration
- Possible magical item rewards (Session 27: 4 party members received permanent magical items)
- Unknown if [[Party Members/Liora Emberveil\|Liora Emberveil]] remains with party
...
- **Liora's Branch Somersault** - Knocked from sled by root, somersaulted around branch mid-air, landed back in moving sled as if nothing happened (Acrobatics 21)
- [[Party Members/Elik'r Stormswallow\|Elik'r Stormswallow]] firebolted [[Party Members/Lady Odonia of Galantri\|Lady Odonia of Galantri]]'s sled, setting it on fire
- [[Party Members/Liora Emberveil\|Liora Emberveil]] threw snowball into [[Party Members/Elik'r Stormswallow\|Elik'r Stormswallow]]'s face whilst simultaneously putting out sled fire
- **Husky Race Winners** - [[Party Members/Lady Odonia of Galantri\|Lady Odonia of Galantri]] & [[Party Members/Liora Emberveil\|Liora Emberveil]] crossed finish line on fire, 1st place
...
- Session recording ended mid-realm, departure mechanism unknown
- [[Party Members/Liora Emberveil\|Liora Emberveil]]'s status uncertain (permanent party member or temporary?)
- Potential magical item distribution pending

**To investigate:**

- How to exit [[Locations/Fizwidget's Winter Realm\|Fizwidget's Winter Realm]]
- [[Party Members/Liora Emberveil\|Liora Emberveil]]'s decision to stay/leave
- Time passage in real world during pocket dimension
- Continue to [[Locations/Moth Queen Cavern\|Moth Queen Cavern]] or reassess priorities

**NPCs to follow up:**

- [[NPCs/Fizwidget Spindleflash\|Fizwidget Spindleflash]] - Pattern of interventions continuing
- 